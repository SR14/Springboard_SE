...
class User {
  ...
  /** Create method to add favorites to User */
  ...
  /** Create a method to remove a favorite from user */
  ...
  /** Get a list of a User's favorite stories */
  async getFavStories(user) {
    // Note presence of `static` keyword: this indicates that getStories is
    //  **not** an instance method. Rather, it is a method that is called on the
    //  class directly. Why doesn't it make sense for getStories to be an
    //  instance method?
  ...
  /** Get a list of a User's own stories */
  async getOwnStories(user) {
    // Note presence of `static` keyword: this indicates that getStories is
    //  **not** an instance method. Rather, it is a method that is called on the
    //  class directly. Why doesn't it make sense for getStories to be an
    //  instance method?
  ...
  /** Create a method to remove a story from user */
